INSERT INTO `ARTICLE`(`id`, `titre`, `resume`, `contenu`, `date_crea`) VALUES
...
Prenez des pauses régulières: Si vous travaillez sur un ordinateur ou passez beaucoup de temps assis, faites des pauses fréquentes pour vous étirer, bouger et reposer vos yeux.", '2023-06-12'),
(4, 'Les meilleures destinations de voyage', 'Explorez les destinations de voyage les plus populaires et découvrez ce qu\'elles ont à offrir.', 'Le contenu de l\'article sur les meilleures destinations de voyage...', '2023-06-11'),
(5, 'Les nouvelles avancées technologiques', 'Découvrez les dernières avancées technologiques qui façonnent notre avenir.', 'Le contenu de l\'article sur les nouvelles avancées technologiques...', '2023-06-10'),
(6, 'Recettes faciles pour les amateurs de cuisine', 'Découvrez des recettes simples et délicieuses pour les passionnés de cuisine.', 'Le contenu de l\'article sur les recettes faciles pour les amateurs de cuisine...', '2023-06-09'),
(7, 'Les films les plus attendus de l\'année', 'Découvrez les films les plus attendus qui sortiront prochainement au cinéma.', 'Le contenu de l\'article sur les films les plus attendus de l\'année...', '2023-06-08'),
